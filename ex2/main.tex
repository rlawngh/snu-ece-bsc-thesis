...
\koreankeywords{지연 정렬 변조, 하이브리드 빔포밍, 공간 광대역 효과, 빔 스퀸트, 심볼 간 간섭, 밀리미터파 통신, 서브 어레이 구조}
\englishkeywords{Delay Alignment Modulation (DAM), Hybrid Beamforming, Spatial Wideband Effect, Beam Squint, Inter-Symbol Interference (ISI), mmWave Communications, Sub-array Architecture}
